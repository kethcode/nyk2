...
contract vEVM {
    ...
    /*//////////////////////////////////////////////////////////////
                            DEFAULT FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // re-enabled payable for puzzle reasons
    ...
    function expand_mem_bytes(
        bytes memory buf,
        uint256 bytes_needed
    ...
    function SAR(vEVMState memory evm) internal pure {
        ...
        uint256 shift = uint256(evm.stack[evm.stack.length - 1]);
        int256 value = int256(uint256(evm.stack[evm.stack.length - 2]));
